...
export class Signer {
  ...
  async signSyncOrderMatching(matching: {
    ...
    return {
      ...
      maker: {
        ...tx.maker,
        is_sell: tx.maker.isSell,
        slot_id: tx.maker.slotId,
        account_id: tx.maker.accountId,
      ...
      taker: {
        ...tx.taker,
        is_sell: tx.taker.isSell,
        slot_id: tx.taker.slotId,
        account_id: tx.taker.accountId,
