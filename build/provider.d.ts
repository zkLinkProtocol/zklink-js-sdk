...
export declare class Provider {
    ...
    chainId: number;
    private constructor();
    setChainId(chainId: number | string): Promise<void>;
    /**
    ...
    static newHttpProvider(address?: string, chainId?: number | string, pollIntervalMilliSecs?: number): Promise<Provider>;
    /**
     * Provides some hardcoded values the `Provider` responsible for
     * without communicating with the network
     */
    static newMockProvider(network: string, ethPrivateKey: Uint8Array, getTokens: Function, chainId: number): Promise<Provider>;
    ...
    getAccountOrderNonce(accountId: number, slotId: number): Promise<PriorityOperationReceipt>;
